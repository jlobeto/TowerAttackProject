...
Shader "AnimatedTexture"
{
	Properties
	{
		_Float0("Float 0", Range( -20 , 20)) = 1.5
		_Color1("Color 1", Color) = (0.4264706,0.4264706,0.4264706,0)
		[Toggle]_ToggleSwitch0("Toggle Switch0", Float) = 1
		_TextureSample0("Texture Sample 0", 2D) = "white" {}
		[HDR]_Color0("Color 0", Color) = (0.321,0.9196755,1,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Albedo33 = ( _Color1 * tex2D( _TextureSample0, uv_TextureSample0 ) );
			o.Albedo = Albedo33.rgb;
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float4 transform5 = mul(unity_ObjectToWorld,float4( ase_vertex3Pos , 0.0 ));
			float GradientY10 = saturate( ( ( transform5.y + _Float0 ) / lerp(-10.0,10.0,_ToggleSwitch0) ) );
			float2 uv_Emission = i.uv_texcoord * _Emission_ST.xy + _Emission_ST.zw;
			float4 Emission27 = ( GradientY10 * ( _Color0 * tex2D( _Emission, uv_Emission ) ) );
...
/*ASEBEGIN
Version=14401
107;64;1783;943;3410.379;1803.083;3.278596;True;True
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;5;-2000.385,215.2941;Float;True;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;3;-1926.983,586.8257;Float;False;Constant;_Float1;Float 1;6;0;Create;True;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1928.717,509.4528;Float;False;Constant;_Float2;Float 2;14;0;Create;True;-10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2;-2039.767,428.8503;Float;False;Property;_Float0;Float 0;0;0;Create;True;1.5;0.7;-20;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;6;-1766.697,534.3797;Float;False;Property;_ToggleSwitch0;Toggle Switch0;2;0;Create;True;1;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;34;-2089.036,-83.53262;Float;True;Property;_Emission;Emission;5;0;Create;True;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;-2086.699,-245.8404;Float;False;Property;_Color0;Color 0;4;1;[HDR];Create;True;0.321,0.9196755,1,0;1,0.6413794,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;30;-1985.822,-1173.283;Float;False;Property;_Color1;Color 1;1;0;Create;True;0.4264706,0.4264706,0.4264706,0;0.6039216,0.6039216,0.6039216,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=720FC39A07087585A0994E8DF10D622635995A47